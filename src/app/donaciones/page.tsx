    ...
    <div className="min-h-screen flex flex-col bg-white">
      <div>
        <p>
          ...
          proceso de transformación en la precisión del tratamiento del cáncer.
          Sigamos sumando años de vida en la lucha contra el cáncer...Apóyanos
        </p>
          ...
          <section className="py-12 px-4 md:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-center mb-12 text-muted-foreground">
                ...
                diagnóstico, logrando la estandarización de biomarcadores antes
                de su uso clínico regular.
              </p>
            </div>
          </section>
        </div>
      ...
      <section>
        <div>
          ...
          <h1 className="titular-Boltext-3xl font-bold text-center mb-8d">
            Testimonios de vida
          </h1>
          <p className="text-lg text-center mb-12 text-muted-foreground">
      ...
      <section className="py-12 px-4 md:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-center mb-12 text-muted-foreground">
            Conecta con otras personas que entiendan lo que estas pasando pueden
            marcar una gran diferencia en tu experiencia con el cáncer. Nuestros
            grupos de apoyo ofrecen un espacio seguro donde podrás compratir,
            aprender y sanar.
          </p>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
                ...
                icon: (
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M17 20h5v-2a3 3 0 00-5.97-.76M9 20H4v-2a3 3 0 015.97-.76M16 3.13a4 4 0 11-8 0M12 7v3m4 0a4 4 0 01-8 0"
                    />
                  </svg>
                ),
                ...
                icon: (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78L12 21.23l9.84-9.84a5.5 5.5 0 000-7.78z"
                    />
                  </svg>
                ),
                ...
                icon: (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M8 15l4 4 4-4m-4-4v8m-4 4h8a2 2 0 002-2v-8a2 2 0 00-2-2H8a2 2 0 00-2 2v8a2 2 0 002 2z"
                    />
                  </svg>
                ),
              ...
              >
                ...
                <button className="mt-auto w-full border border-gray-300 text-gray-600 rounded-lg py-2 hover:bg-gray-100">
                  Unéte al Grupo
                </button>
              </div>
            ))}
          ...
          <div className="mt-12 text-center">
            <button className="px-6 py-3 bg-blue-600 text-white text-lg font-bold rounded-lg hover:bg-blue-700">
              CONTÁCTANOS
            </button>
          </div>
        </div>

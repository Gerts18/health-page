  ...
  const slides = [
    {
      ...
      titleStyle: "text-8xl font-bold text-[#6A6A6A] w-1/2 px-20",
      descriptionStyle: "text-2xl text-[#6A6A6A] w-1/2 px-24",
      buttonStyle:
      ...
      >
        ...
        <div className="absolute top-2/3 left-1/2 transform -translate-y-1/2">
          <Link href={slides[currentIndex].link}>
            <button
              className={`w-full shadow-md py-3 px-6 rounded-full transition duration-200 ${slides[currentIndex].buttonStyle}`}
            >
              {" "}

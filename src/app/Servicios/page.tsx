...
const services: Service[] = [
  ...
  },
  {
    ...
    resumen:
      "Cáncer que afecta los ovarios en el sistema reproductivo femenino",
    description:
  ...
  },
  {
    ...
    resumen:
      "Cáncer que afecta los pulmones, a menudo relacionado con el tabaquismo",
    description:
  ...
  },
  {
    ...
    images: [
      "/assets/melanoma1.png",
      "/assets/melanomaMP.jpg",
      "/assets/melanomaA.jpg",
    ],
  ...
  },
  {
    title: "Parálisis NGS",
    resumen:
      "Una condición que afecta el movimiento voluntario de ciertas áreas del cuerpo",
    description:
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            {
              // Muestra el resumen del servicio.
            }{" "}
          </div>

          <div className="space-y-4">
            <h4 className="font-bold text-lg text-[#547EED]">
              Descripción detallada
            </h4>
            <div className="text-gray-600 text-justify whitespace-pre-line">
              {service.description}
              {
                // Muestra la descripción detallada del servicio.
              }
            </div>

            <div className="mt-8 bg-gradient-to-r from-blue-50 to-pink-50 p-6 rounded-xl">
              <h4 className="font-bold text-lg text-[#547EED] mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <h5 className="font-semibold text-[#EB356E] mb-2">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-sm text-gray-600">
                    Tratamiento de apoyo para mejorar la eficacia del
            ...
            {service.tratamientos && ( // Si hay tratamientos disponibles, los muestra.
              <div className="mt-6">
                <h4 className="font-bold text-lg text-[#547EED] mb-2">
            ...
            {service.testimonios &&
              service.testimonios.length > 0 && ( // Si hay testimonios, los muestra.
                <div className="mt-6">
                  <h4 className="font-bold text-lg text-[#547EED] mb-4">
                    Testimonios
                  </h4>
                  <div className="space-y-4">
                    {service.testimonios.map((testimonio, index) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg">
                        ...
                        {
                          // Muestra el autor del testimonio.
                        }
                      </div>
                    ))}
                  </div>
          ...
          <div className="bg-pink-50 p-4 rounded-lg">
            <h4 className="font-bold text-lg text-[#EB356E] mb-2">
              Información adicional
            </h4>
            <p className="text-gray-700">
              Para más información sobre este tratamiento o para agendar una
              cita, por favor contacte a nuestro equipo médico.
            </p>
          </div>
        </div>
      </motion.div>
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-16">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex items-center">
              <h2 className="text-4xl font-bold text-[#547EED] leading-tight text-center md:text-left">
                ¿Preferirías quedarte en casa que ir a un centro de atención
                médica?
              </h2>
            </div>
            <div>
              <p className="text-[#EB356E] text-lg">
                Cada día, miles de personas luchan contra el cáncer, un reto que
                requiere no solo tratamientos médicos, sino también apoyo,
                esperanza y solidaridad. La detección temprana, el acceso a
                tratamientos y el acompañamiento emocional son vitales en esta
                batalla. Juntos, podemos crear conciencia, promover la
                prevención y brindar el respaldo que cada persona merece en su
                camino hacia la recuperación. Que esta lucha nos inspire a
                construir un futuro con más salud, más ciencia y más esperanza
        ...
        <motion.section className="mb-24">
          ...
          >
            <h3 className="text-xl font-bold text-[#EB356E] mb-4">
              Patologías
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {services.slice(0, 8).map(
              (
                service,
                index // Muestra los primeros 8 servicios.
              ) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <h4 className="text-[#EB356E] font-bold mb-4">
                    {service.title}
                  </h4>
                  {
                    // Título del servicio.
                  ...
                  {
                    // Botón para leer más sobre el servicio.
                  }
                </motion.div>
              )
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto mt-8">
            {services.slice(8).map(
              (
                service,
                index // Muestra los servicios restantes.
              ) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, scale: 0.9 }} // Animación inicial.
